class Simulation(object):
    #Constructor
    def __init__(self, name, box_dim : list, t_step, particle_radius):
        #Set simulation inputs
        self.name=name                          #Name of the simulation
        self.box_dim=box_dim                    #Dimensions of the box
    ...
    def _generate_initial_positions(self, n, distrib="uniform"):
        if distrib == "uniform":
            self._positions=np.random.uniform(low = [0]*self.dim, high = self.box_dim, size = (n,self.dim))
