...
class Planet:
    ...
    def visualize_2body(self, moon, current_time, dt):
        ...
        while True:
            ...
            if lab_time_day > 130 and time.process_time_ns() - current_time >= DRAW_NS_DELTA:
                # print("########################################")
                ...
                earth_circle = plt.Circle((self.position.x, self.position.y),
                                          radius=CRITICAL_DISTANCE, alpha=.3)
